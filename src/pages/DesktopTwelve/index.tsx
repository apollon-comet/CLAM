...
const DesktopTwelvePage: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-kleeone mx-auto pb-[127px] relative w-full">
        ...
        <div className="md:h-[694px] h-[773px] mb-auto ml-[39px] mt-[-8px] md:px-5 w-[43%] md:w-full z-[1]">
          <div className="absolute bg-indigo-300 bottom-[0] flex flex-col gap-[33px] justify-center p-[35px] sm:px-5 right-[0] rounded-[35px] w-[91%]">
            <div className="flex flex-col font-karantina gap-[47px] items-start justify-start md:ml-[0] ml-[179px] mr-[154px] mt-6 w-[31%] md:w-full">
              <Img
                className="h-[117px] md:h-auto object-cover w-[83%] sm:w-full"
                src="images/img_image13.png"
                alt="imageThirteen"
              />
              <Text
                className="md:text-3xl sm:text-[28px] text-[32px] text-justify text-white-A700 tracking-[5.12px]"
                size="txtKarantinaRegular32WhiteA700"
              >
                SKIZOFRENIA
              </Text>
            </div>
            <Text
              className="mb-[7px] mr-0.5 text-2xl md:text-[22px] text-justify text-white-A700 sm:text-xl w-full"
              size="txtKameron24"
            >
              Skizofrenia adalah ggangguan mental berat yang dapat memengaruhi
              tingkah laku, emosi, dan komunikasi. Penderita Skizofrenia bisa
              mengalami hallusinasi, delusi, kekacauan berpikir, dan perubahan
              perilaku.
            </Text>
          </div>
          <Img
