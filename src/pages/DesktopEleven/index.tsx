    ...
    <>
      <div className="bg-white-A700 flex flex-col font-kleeone mx-auto pb-[127px] relative w-full">
        ...
        <div className="md:h-[694px] h-[773px] mb-auto ml-[39px] mt-[-8px] md:px-5 w-[43%] md:w-full z-[1]">
          <div className="absolute bg-deep_purple-700 bottom-[0] flex flex-col items-center justify-start p-[35px] sm:px-5 right-[0] rounded-[35px] w-[91%]">
            <Img
              className="h-[167px] md:h-auto mt-1.5 object-cover rounded-sm w-[38%] sm:w-full"
              src="images/img_image12.png"
              alt="imageTwelve"
            />
            <Text
              className="text-4xl sm:text-[32px] md:text-[34px] text-justify text-white-A700 tracking-[5.76px]"
            ...
            <Text
              ...
              size="txtKameron24"
            >
              Depresi adalah gangguan suasana hati yang ditandai dengan perasaan
              sedih yang mendalam dan kehilangan minat terhadap hal-hal yang
              disukai. Seseorang dinyatakan mengalami depresi jika sudah dua
